    ...
    <section id="contacto" className="relative bg-mist pt-4 pb-20 md:pb-24">
      <div className="container-x">
        ...
        <motion.div
          ...
          className="relative mx-auto max-w-[920px] rounded-2xl bg-ink text-paper px-8 md:px-16 py-20 md:py-24 overflow-hidden"
        >
          ...
          <div className="relative text-center space-y-6">
            <p className="text-[11px] tracking-[0.32em] uppercase text-gold">Espacio reservado</p>
            <p className="font-serif text-2xl md:text-3xl leading-snug max-w-xl mx-auto">
              Añadir formulario, Calendly o link de contacto.
            </p>
            <p className="text-sm text-paper/60 max-w-md mx-auto">
            ...
            <div className="pt-6 flex flex-wrap justify-center gap-3">
              {[
                ...
                <motion.button
                  ...
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center gap-2 rounded-full border border-paper/30 px-5 py-2.5 text-xs uppercase tracking-widest hover:border-gold hover:text-gold transition-colors"
                >
                  <b.icon size={14} />
                  {b.label}
                </motion.button>
